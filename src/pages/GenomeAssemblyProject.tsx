  ...
  return (
    <article className="space-y-8">
      <div>
        ...
        <p className="mt-2 inline-flex items-center gap-2 rounded-full bg-(--primary)/10 dark:bg-(--primary)/20 px-3 py-1 text-sm font-medium text-(--primary)">
          ...
          <div className="relative">
            ...
            <ul className="space-y-0">
              ...
              <li className="relative flex gap-4 pb-8">
                <div className="relative z-10 flex h-8 w-8 shrink-0 items-center justify-center rounded-full border-2 border-(--primary) bg-(--primary) text-xs font-semibold text-white shadow-md">
                  1
                </div>
              ...
              {/* Phase 2 */}
              <li className="relative flex gap-4 pb-8">
                <div className="relative z-10 flex h-8 w-8 shrink-0 items-center justify-center rounded-full border-2 border-(--border) bg-(--bg) text-sm font-semibold text-(--text-muted)">
                  2
                </div>
                <div className="min-w-0 flex-1 pt-0.5">
                  <span className="font-semibold text-(--text)">
        ...
        <div className="space-y-6 prose prose-stone dark:prose-invert max-w-none">
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2 text-(--text-muted)">
              <li>
                <strong className="text-(--text)">Screening</strong> — Identify
              ...
              <li>
                <strong className="text-(--text)">Modeling</strong> — Capture
                parameter effects and identify robust configurations.
              </li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2 text-(--text-muted)">
              <li>
                <strong className="text-(--text)">Short term:</strong> Complete
                the sensitivity experiments and publish the results.
              </li>
              <li>
                <strong className="text-(--text)">Long term:</strong> Extend
                this methodology to adapt parameter selection based on the
                characteristics of diverse DNA sequencing datasets.
              </li>
            </ul>
          </section>
        </div>
